...
export const WorkOrderModal: React.FC<WorkOrderModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white border border-slate-200 rounded-3xl max-w-xl w-full max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 bg-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-sans font-normal">Specify production targets, assignment, and timelines</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 flex-1 font-sans">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-[30px] text-xs text-slate-800 focus:outline-none focus:border-blue-500 focus:bg-white disabled:bg-slate-100 disabled:text-slate-500 font-mono transition-colors"
              />
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-medium text-slate-700 mb-1">
                Planned Quantity (Units) <span className="text-rose-500">*</span>
              </label>
              <input
                type="number"
                required
                ...
                className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-[30px] text-xs text-slate-800 focus:outline-none focus:border-blue-500 focus:bg-white font-mono tabular-nums transition-colors"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-slate-700 mb-1">Assign Machine</label>
              <select
            ...
            <div>
              <label className="block text-xs font-medium text-slate-700 mb-1">Assign Operator</label>
              <select
          ...
          <div>
            <label className="block text-xs font-medium text-slate-700 mb-1">Remarks / Instructions</label>
            <textarea
              rows={2}
